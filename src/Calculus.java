...
public class Calculus extends JFrame {
    ...
    private int timePassed; // The time taken to finish the questions
    private Timer timer;
    private Instant startTime;

    public Calculus() {// List<Question> questions) {
        super("CALCULUS");
        ...
        nextButton = new JButton("Suivant 1/10");
        ...
        timeLabel = new JLabel("Temps passed: 00:00");
    ...
    private void startNewGame(List<Question> questions) {
        ...
        timeLabel.setText("Temps passed: 00:00");
        if (scoreLabel != null)
        ...
        timer = new Timer(1000, new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                timePassed = (int) Duration.between(startTime, now).getSeconds();
                int minutes = timePassed / 60;
                int seconds = timePassed % 60;
                timeLabel.setText("Temps passed: " + String.format("%02d:%02d", minutes, seconds));
            }
        });
        timer.start();
